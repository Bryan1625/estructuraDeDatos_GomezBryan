...
public class ListaDoble<T> implements Iterable<T> {
    ...
    public ListaDoble() {
        nodoPrimero = null;
        nodoUltimo = null; // En lugar de nodoPrimero = null;
        tamanio = 0;
    }
    ...
    public IteradorListaDoble iteratorListaDoble() {
    ...
    protected class IteradorListaDoble implements Iterator<T>{
         ...
         */
        public IteradorListaDoble(NodoDoble<T> nodoPrimero, NodoDoble<T> nodoUltimo) {
